...
-- Recriar tabela para transações
...
-- Recriar tabela para categorias
...
-- Criar políticas permissivas para todos os usuários
...
-- Recriar trigger para atualizar updated_at automaticamente
